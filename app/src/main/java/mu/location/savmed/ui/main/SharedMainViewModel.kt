 ...
 */
package mu.location.savmed.ui.main
...
import mu.location.savmed.ui.main.recordings.model.RecordingModel
...
class SharedMainViewModel @UiThread constructor() : ViewModel() {
    ...
    val defaultAccountAvatar = MutableLiveData<ContactAvatarModel>()
